...
2. **套件已裝**：`Rscript setup/install.r` 一次裝齊 14 個套件（含 PSM 用的 `MatchIt` + `cobalt`）。
...
完整版在 [`data/data_dictionary.md`](https://github.com/htlin222/roche-vabysmo-rwe-workshop/blob/main/data/data_dictionary.md)。一頁懶人包：
